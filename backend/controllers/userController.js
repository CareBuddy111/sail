...
const paymentRazorpay = async (req, res) => {
  ...
  try {
    ...
    const order = await razorpaayInstance.orders.create(options)
...
export {registerUser, loginUser, getProfile, updateProfile,  bookAppointment, listAppointment, cancelAppointment} // paymentRazorpay,verifyRazorpay initializePayment, verifyPayment}